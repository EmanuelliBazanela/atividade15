...
class LivroRepository with ChangeNotifier {
  ...
  */
  Uri _getApiEndPoint() {
    return Uri.https(
        URL_API, '/livro.json', {'auth': _servicoAutenticacao.usuario?.token});
  }
  ...
  */
  ...
  List<Livro> get livro {
    return UnmodifiableListView(_lista);
  }

  List<Livro> get favoritos {
    return UnmodifiableListView(
      _lista.where((livro) => livro.favorito),
    );
  }
  ...
  ///um [Result] com a lista des. A classe [Result]
  ...
  Future<String?> adicionar(String titulo, String autor, String edicao,
      String date, String descricao, String urlImagem) async {
